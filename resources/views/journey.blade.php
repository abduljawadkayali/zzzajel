    ...
    <section id="contact" class="contact">
        <div class="container-fluid">
            ...
            <div style="padding: 20px">
                <iframe src="{{$selectedjourney->lan}}" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-end">
                <div class="col-12 ">
                    <div class="container-fluid">
                        <div class="row ">
                            <div class="col-6 ">
                                <h2 style="padding: 25px!important; text-align: left!important;">{{ $selectedjourney->name }}</h2>
                                            ...
                                            <div class="swiper-wrapper">
                                                ...
                                                @foreach($newData as $item)
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div  class="timestamp"><span class="date"> <a href= "{{ URL::to('lines/'.$item->id.'') }}"> {{$item->name}}</a></span></div>
